...
import util
#ADNI
data_folder = "ADNI/correlation/"
# ABIDE
# data_folder = "ABIDE/correlation/"
...
#ADNI correlation_matrix，ABIDE connectivity
def get_networks(subject_list, kind, atlas_name="ho", variable='correlation_matrix'):
...
def get_node_feature():
    ...
    parser = argparse.ArgumentParser(description='Classification of the ADNI dataset')
