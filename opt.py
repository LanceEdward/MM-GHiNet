...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--ckpt_path', type=str, default='/data4t/lichao/MMResNet/model', help='checkpoint path to save trained models')
    ...
    def print_args(self):
        ...
        print("==========     CONFIG END    =============")
        print("\n")
        phase = 'train' if self.args.train==0 else 'eval'
